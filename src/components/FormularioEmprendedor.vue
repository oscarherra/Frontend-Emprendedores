  ...
  <div class="form-container">
    ...
    <form v-if="!formStore.isFormSubmitted" @submit.prevent="formStore.submitForm" class="entrepreneur-form">
        ...
        <fieldset>
          ...
          <div class="form-grid">
            <div class="form-group">
              <label for="nombreCompleto">Nombre completo del emprendedor*</label>
              <input type="text" id="nombreCompleto" v-model="formStore.formData.informacionGeneral.nombreCompleto" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="contacto">Número de teléfono / correo electrónico*</label>
              <input type="text" id="contacto" v-model="formStore.formData.informacionGeneral.contacto" required>
            </div>
          </div>
          <div class="form-group">
      ...
      <div class="navigation-buttons">
        ...
        <div v-else></div>
        <button type="button" v-if="formStore.currentStep < 4" @click="formStore.nextStep" class="btn-primary">Siguiente</button>
