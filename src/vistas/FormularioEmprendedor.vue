<template>
  <div id="public-form-layout">
    ...
    <main class="form-container">
      ...
      <form
        v-if="!formStore.isFormSubmitted"
        @submit.prevent="formStore.submitForm"
        class="entrepreneur-form"
        novalidate
      >
          ...
          <fieldset>
            ...
            <div class="form-grid">
              ...
              <div class="form-group">
                ...
                <input
                  type="text"
                  id="nombre"
                  v-model="formStore.formData.informacionGeneral.nombre"
                  required
                >
              </div>
              <!-- CAMPO APELLIDO 1 -->
              <div class="form-group">
                ...
                <input
                  type="text"
                  id="apellido1"
                  v-model="formStore.formData.informacionGeneral.apellido1"
                  required
                >
              </div>
              <!-- CAMPO APELLIDO 2 -->
              <div class="form-group">
                ...
                <input
                  type="text"
                  id="apellido2"
                  v-model="formStore.formData.informacionGeneral.apellido2"
                  required
                >
              </div>
              ...
              <div class="form-group">
                ...
                <input
                  type="text"
                  id="cedula"
                  v-model="formStore.formData.informacionGeneral.cedula"
                  required
                >
              </div>
              <div class="form-group">
                ...
                <input
                  type="date"
                  id="fechaNacimiento"
                  v-model="formStore.formData.informacionGeneral.fechaNacimiento"
                  required
                >
              </div>
              <div class="form-group">
                ...
                <input
                  type="number"
                  id="edad"
                  v-model.number="formStore.formData.informacionGeneral.edad"
                  required
                >
              </div>
              <div class="form-group">
                ...
                <select
                  id="sexo"
                  v-model="formStore.formData.informacionGeneral.sexo"
                  required
                >
              ...
              <div class="form-group">
                ...
                <input
                  type="tel"
                  id="telefono"
                  v-model="formStore.formData.informacionGeneral.telefono"
                  required
                >
              </div>
              ...
              <div class="form-group">
                ...
                <input
                  type="email"
                  id="correo"
                  v-model="formStore.formData.informacionGeneral.correo_electronico"
                  required
                >
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <input
                type="text"
                id="direccion"
                v-model="formStore.formData.informacionGeneral.direccion"
                required
              >
            </div>
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <select
                  id="distrito"
                  v-model="formStore.formData.informacionGeneral.distrito"
                  required
                >
                  <option disabled value="">Seleccione un distrito</option>
                  <option
                    v-for="distrito in distritosOptions"
                    :key="distrito"
                    :value="distrito"
                  >
                    {{ distrito }}
              ...
              <div class="form-group">
                ...
                <input
                  type="text"
                  id="comunidad"
                  v-model="formStore.formData.informacionGeneral.comunidad"
                  required
                >
              </div>
            </div>
        ...
        <div v-show="formStore.currentStep === 2">
          <fieldset>
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input
                  type="text"
                  id="nombreNegocio"
                  v-model="formStore.formData.infoEmprendimiento.nombreNegocio"
                  required
                >
              </div>
              <div class="form-group">
                ...
                <div class="radio-options-wrapper">
                  <div class="radio-option">
                    <input
                      ...
                      id="individual"
                      value="Individual"
                      v-model="formStore.formData.infoEmprendimiento.tipo"
                      required
                    >
            ...
            <div class="form-group">
              ...
              <textarea
                id="descripcion"
                v-model="formStore.formData.infoEmprendimiento.descripcion"
                rows="4"
                required
              ></textarea>
            </div>
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <select
                  id="nivelEducativo"
                  v-model="formStore.formData.infoEmprendimiento.nivelEducativo"
                >
              ...
              <div class="form-group">
                ...
                <input
                  type="number"
                  id="anoInicio"
                  v-model.number="formStore.formData.infoEmprendimiento.anoInicio"
                  placeholder="Ej: 2020"
                >
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="image-uploader-container">
                ...
                <label
                  for="imagenes"
                  class="upload-label"
                  v-if="!formStore.imageFiles || formStore.imageFiles.length < 4"
                >
                  <svg
            ...
            <div class="form-grid">
                ...
                <div class="radio-options-wrapper">
                  <div class="radio-option">
                    <input
                      ...
                      id="logoSi"
                      value="Si"
                      v-model="formStore.formData.infoEmprendimiento.logo"
                      required
                    >
              ...
              <div class="form-group">
                <label class="group-label">¿Tiene Eslogan?*</label>
                <div class="radio-options-wrapper">
                  <div class="radio-option">
                    <input
                      type="radio"
                      id="sloganSi"
                      value="Si"
                      v-model="formStore.formData.infoEmprendimiento.slogan"
                      required
                    >
                    <label for="sloganSi">Sí</label>
                  </div>
                  <div class="radio-option">
                    <input
                      type="radio"
            ...
            <div class="form-group">
              ...
              <div class="sector-selector-container">
                <button
                  ...
                  :key="sector.name"
                  class="sector-button"
                  :class="{ selected: formStore.formData.infoEmprendimiento.sector === sector.name }"
                  @click="formStore.formData.infoEmprendimiento.sector = sector.name"
                >
                  <div class="icon-wrapper">
                    <template v-if="sector.name === 'Otros'">
                      <span class="plus-icon">+</span>
                    </template>
                    <template v-else>
                      <img :src="sector.icon" alt="" class="sector-image" />
                    </template>
                  </div>
            ...
            <div
              v-if="formStore.formData.infoEmprendimiento.sector === 'Cultural'"
              class="form-group indented"
            >
              <label>Si pertenece al sector cultural, especifique cuál:</label>
              <div class="checkbox-grid">
                <div
                  v-for="opcion in sectoresCulturales"
                  :key="opcion"
                >
                  <input
                    type="checkbox"
                    :id="opcion"
                    :value="opcion"
                    v-model="formStore.formData.infoEmprendimiento.especificacionCultural"
                  >
              ...
              <input
                ...
                v-model="formStore.formData.infoEmprendimiento.otroCultural"
                class="otro-input"
              >
            </div>
            ...
            <div class="form-group">
              ...
              <input
                type="number"
                id="numEmpleados"
                v-model.number="formStore.formData.infoEmprendimiento.numEmpleados"
              >
            </div>
                ...
                <div class="radio-options-wrapper">
                  <div class="radio-option">
                    <input
                      ...
                      id="sillasSi"
                      value="Si"
                      v-model="formStore.formData.infoEmprendimiento.utileria.sillas"
                    >
                ...
                <div class="radio-options-wrapper">
                  <div class="radio-option">
                    <input
                      ...
                      id="mesasSi"
                      value="Si"
                      v-model="formStore.formData.infoEmprendimiento.utileria.mesas"
                    >
                ...
                <div class="radio-options-wrapper">
                  <div class="radio-option">
                    <input
                      ...
                      id="toldoSi"
                      value="Si"
                      v-model="formStore.formData.infoEmprendimiento.utileria.toldo"
                    >
              ...
              <div class="radio-options-wrapper">
                <div class="radio-option">
                  <input
                    ...
                    id="feriaSi"
                    value="Si"
                    v-model="formStore.formData.infoEmprendimiento.participoFeria"
                  >
            ...
            <div
              v-if="formStore.formData.infoEmprendimiento.participoFeria === 'Si'"
              class="form-group indented"
            >
              ...
              <input
                type="text"
                id="cualesFerias"
                v-model="formStore.formData.infoEmprendimiento.cualesFerias"
              >
            </div>
            ...
            <div class="form-group">
              ...
              <input
                type="text"
                id="signosExternos"
                v-model="formStore.formData.infoEmprendimiento.signosExternos"
              >
            </div>
            ...
            <div class="form-group">
              ...
              <input
                type="text"
                id="certificaciones"
                v-model="formStore.formData.infoEmprendimiento.certificaciones"
              >
            </div>
            ...
            <div class="form-grid-social">
              <div class="form-group">
                ...
                <input
                  type="text"
                  id="facebook"
                  v-model="formStore.formData.infoEmprendimiento.redes.facebook"
                >
              </div>
              <div class="form-group">
                ...
                <input
                  type="text"
                  id="instagram"
                  v-model="formStore.formData.infoEmprendimiento.redes.instagram"
                >
              </div>
              <div class="form-group">
                ...
                <input
                  type="text"
                  id="tiktok"
                  v-model="formStore.formData.infoEmprendimiento.redes.tiktok"
                >
              </div>
              <div class="form-group">
                ...
                <input
                  type="text"
                  id="website"
                  v-model="formStore.formData.infoEmprendimiento.redes.website"
                >
              </div>
              <div class="form-group">
                <label for="whatsapp">WhatsApp / WhatsApp Business</label>
                <input
                  type="text"
                  id="whatsapp"
                  v-model="formStore.formData.infoEmprendimiento.redes.whatsapp"
                >
              </div>
            </div>
          </fieldset>
        ...
        <div v-show="formStore.currentStep === 3">
          <fieldset>
            ...
            <div class="checkbox-grid">
              <div
                v-for="item in formalizacionOptions"
                :key="item"
              >
                <input
                  type="checkbox"
                  :id="item"
                  :value="item"
                  v-model="formStore.formData.formalizacion"
                >
        ...
        <!-- Paso 4: Necesidades y Proyecciones -->
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input
                type="text"
                id="necesidadActual"
                v-model="formStore.formData.necesidades.necesidadActual"
              >
            </div>
              ...
              <div class="radio-options-wrapper">
                <div class="radio-option">
                  <input
                    ...
                    id="interesSi"
                    value="Si"
                    v-model="formStore.formData.necesidades.interesTalleres"
                  >
                  <label for="interesSi">Sí</label>
                </div>
                <div class="radio-option">
                  <input
                    type="radio"
              ...
              <div class="checkbox-grid">
                ...
                >
                  <input
                    ...
                    :id="apoyo"
                    :value="apoyo"
                    v-model="formStore.formData.necesidades.tipoApoyo"
                  >
...
const onCaptchaOk = () => {
  // El captcha fue validado correctamente:
  mostrarCaptcha.value = false;
  formStore.resetForm();   // vuelve el formulario al paso 1 para un nuevo registro
};
...
// Opciones de sectores con imágenes
const sectorOptions = ref([
  {
    name: 'Turismo',
    icon: new URL('../assets/Turismo.png', import.meta.url).href
  },
  {
    name: 'Alimentos',
    icon: new URL('../assets/Alimentos.png', import.meta.url).href
  },
  {
    name: 'Belleza',
    icon: new URL('../assets/Belleza.png', import.meta.url).href
  },
  {
    name: 'Servicios',
    icon: new URL('../assets/Servicios.png', import.meta.url).href
  },
  {
    name: 'Cultural',
    icon: new URL('../assets/Cultural.png', import.meta.url).href
  },
  {
    name: 'Otros',
...
const apoyoOptions = [
  ...
  'Espacios para mostrar su trabajo',
  'Formalización'
];
...
const validateCurrentStep = () => {
  ...
  if (formStore.currentStep === 1) {
    const data = formStore.formData.informacionGeneral;

    const missingFields = [];

    if (!data.nombre || !data.nombre.trim()) missingFields.push('Nombre');
    if (!data.apellido1 || !data.apellido1.trim()) missingFields.push('Primer Apellido');
    if (!data.apellido2 || !data.apellido2.trim()) missingFields.push('Segundo Apellido');
    if (!data.cedula || !data.cedula.trim()) missingFields.push('Cédula de identidad');
    if (!data.fechaNacimiento) missingFields.push('Fecha de nacimiento');
    if (data.edad === null || data.edad === '' || data.edad === undefined) missingFields.push('Edad');
    if (!data.sexo) missingFields.push('Sexo');
    if (!data.telefono || !data.telefono.trim()) missingFields.push('Número de teléfono');
    if (!data.correo_electronico || !data.correo_electronico.trim()) missingFields.push('Correo electrónico');
    if (!data.direccion || !data.direccion.trim()) missingFields.push('Dirección de la actividad');
    if (!data.distrito) missingFields.push('Distrito al que pertenece');
    if (!data.comunidad || !data.comunidad.trim()) missingFields.push('¿Comunidad?');
  ...
  if (formStore.currentStep === 2) {
    const data = formStore.formData.infoEmprendimiento;

    const missingFields = [];

    if (!data.nombreNegocio || !data.nombreNegocio.trim()) {
      missingFields.push('Nombre del negocio o emprendimiento');
    }
    if (!data.tipo) {
      missingFields.push('Tipo de emprendimiento');
    }
    if (!data.descripcion || !data.descripcion.trim()) {
      missingFields.push('Descripción breve del emprendimiento');
    }
    if (!data.logo) {
      missingFields.push('¿Tiene Logo?');
    }
    if (!data.slogan) {
      missingFields.push('¿Tiene Eslogan?');
    }
    if (!data.sector) {
...
/* Íconos blancos cuando el sector está seleccionado */
.sector-button.selected .sector-image {
...
.sector-button.selected .plus-icon {
  color: #ffffff;
}
